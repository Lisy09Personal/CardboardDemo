...
struct  SslStreamBase_t823  : public Stream_t812
{
	...
	ManualResetEvent_t811 * ___negotiationComplete_13;
	...
	MemoryStream_t829 * ___recordStream_15;
};
struct SslStreamBase_t823_StaticFields{
	// System.Threading.ManualResetEvent Mono.Security.Protocol.Tls.SslStreamBase::record_processing
	ManualResetEvent_t811 * ___record_processing_2;
};
