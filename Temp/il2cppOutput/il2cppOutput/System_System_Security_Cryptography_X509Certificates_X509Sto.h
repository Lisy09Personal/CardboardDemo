...
struct  X509Store_t965  : public Object_t
{
	...
	X509Certificate2Collection_t959 * ___list_2;
	...
	X509Store_t768 * ___store_4;
};
struct X509Store_t965_StaticFields{
	...
	Dictionary_2_t254 * ___U3CU3Ef__switchU24mapF_5;
};
