...
// StereoController
struct  StereoController_t32  : public MonoBehaviour_t2
{
	...
	Transform_t40 * ___centerOfInterest_7;
	...
	CardboardEyeU5BU5D_t63* ___eyes_15;
	// CardboardHead StereoController::head
	CardboardHead_t39 * ___head_16;
	// UnityEngine.Camera StereoController::<camera>k__BackingField
	Camera_t31 * ___U3CcameraU3Ek__BackingField_17;
};
struct StereoController_t32_StaticFields{
	// System.Func`2<CardboardEye,CardboardHead> StereoController::<>f__am$cache10
	Func_2_t64 * ___U3CU3Ef__amU24cache10_18;
};
