...
struct  FtpWebRequest_t934  : public WebRequest_t896
{
	...
	RemoteCertificateValidationCallback_t893 * ___callback_15;
};
struct FtpWebRequest_t934_StaticFields{
	...
	RemoteCertificateValidationCallback_t893 * ___U3CU3Ef__amU24cache1C_16;
};
